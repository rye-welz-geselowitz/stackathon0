var menuState={
     create: function(){
        ...
        var challenge=game.add.text(game.world.centerX,game.world.centerY-80,challengeString1,mediumWhite); 
        var challenge2=game.add.text(game.world.centerX,game.world.centerY-40,challengeString2,largeWhite); 
